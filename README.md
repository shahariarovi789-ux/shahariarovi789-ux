...
* 🎓 **[ROAR — Adaptive Prompt Engineering Tutor](https://github.com/shahariarovi789-ux/roar-prompt-tutor)**: Capstone project implementing an adaptive prompt engineering tutor using quantized local DeepSeek-7B models fine-tuned with PEFT/LoRA adapters.
